      ...
      <div className=" container m-auto  mt-16">
        ...
        <div className="flex md:flex-col ">
          ...
          <div className="right relative flex-1 flex flex-wrap p-5 gap-10 items-center justify-center sm:w-full">
            <div className="first3 flex flex-row gap-10">
            <SkillBox
                logo={<IoLogoNodejs />}
                black={"black"}
                white={"white"}
            ...
            <div className="last3 flex flex-row gap-10">
              <SkillBox
                logo={<SiExpress />}
                black={"black"}
                white={"white"}
              ...
              <SkillBox
                className=""
                logo={
                  <FiDatabase className=" text-white bg-black rounded-full h-fit border-white overflow-hidden" />
                }
                black={"white"}
                white={"black"}
                skill={"Sql Database"}
